...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_S00_AXI_BASEADDR {0x40000000} \
   CONFIG.C_S00_AXI_HIGHADDR {0x4000FFFF} \
 ] $S_AXI_VGA_BRAM_0
  ...
  set_property -dict [ list \
   CONFIG.C_S00_AXI_BASEADDR {0x80000000} \
   CONFIG.C_S00_AXI_HIGHADDR {0x8000FFFF} \
 ] $keyboard_0
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins S_AXI_VGA_BRAM_0/s00_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins keyboard_0/s00_axi_aclk] [get_bd_pins manager_0/m00_axi_aclk] [get_bd_pins manager_0_axi_periph/ACLK] [get_bd_pins manager_0_axi_periph/M00_ACLK] [get_bd_pins manager_0_axi_periph/M01_ACLK] [get_bd_pins manager_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins S_AXI_VGA_BRAM_0/clk_50Mhz] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins keyboard_0/CLOCK_50MHz]
  ...
  connect_bd_net -net reset_rtl_1 [get_bd_ports reset_rtl] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces manager_0/M00_AXI] [get_bd_addr_segs S_AXI_VGA_BRAM_0/S00_AXI/S00_AXI_reg] SEG_S_AXI_VGA_BRAM_0_S00_AXI_reg
