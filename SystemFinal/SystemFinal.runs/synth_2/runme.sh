...
HD_PWD='C:/Users/caraccmv/Desktop/git/EE316P6/SystemFinal/SystemFinal.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log dgn_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dgn_wrapper.tcl
