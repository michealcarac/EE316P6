...
HD_PWD='C:/Users/caraccmv/Desktop/git/EE316P6/SystemFinal/SystemFinal.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log dgn_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dgn_wrapper.tcl -notrace
